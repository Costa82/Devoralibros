        ...
        <div class="container">
            <div class="form-box">
                <div class="form-top">
                    <div class="form-top-left">
                      ...
                      <p>Si no estás registrado, <a href='../FormularioRegistro/'>regístrate</a></p>
                        <div id='errores'>
                            <?php
                ...
                <div class="form-bottom">
                    <form role="form" action="../php/logueo_header.php" method="post" class="login-form">
			...
			<div class="form-group">
			    ...
			    <input type="password" name="contrasena" placeholder=Contraseña... required="required"/>
                        ...
                        <h3><a href="../FormularioEnvioContraseña/">He olvidado la contraseña y/o el Nick...</a></h3>
                        <div class="botones">
