...
<head>
    ...
    <meta name="description" content="Leer no es solo mezclarse con las palabras de unas páginas encuadernadas, es adentrarse en un mundo creado por alguien para si mismo, para ti,
    ...
    <script src="jquery/jquery_premios.js"></script>
    <script src="jquery/jquery_conocenos.js"></script>
		...
		<div id='slider'>
			...
			<div id='buscador'>
				<form action="Buscador/" method="POST">
					<label><p>Busca tu libro</p>
						<input type="search" name="nombre" placeholder="Buscar"></label>
				</form>
			</div>
