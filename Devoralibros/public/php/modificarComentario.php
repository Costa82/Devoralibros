            ...
            <div class="form-bottom">
             ...
             <div class="form-group">
               <label><span>* </span>Comentario</label>
                 <textarea name="comentario" rows="10" cols="40" required="required"><?php echo strip_tags($comentario); ?></textarea>
             </div>             
            <div class="botones">
            <button type="submit" name="modificar" class='btn'>Modificar comentario</button>
            <?php
