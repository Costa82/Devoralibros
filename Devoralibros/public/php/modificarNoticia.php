                ...
                <form enctype="multipart/form-data" action="#" method="POST" class="login-form">
                     ...
                     <div class="form-group">
                         <label>Fuente de la noticia</label>
                           <input type="text" name="fuente" size="500" value="<?php echo $fuente; ?>"/>
                       </div>
                     <div class="form-group">
                     <label>Cambia la imagen de la noticia: <img src="../img_noticias/<?php echo $img_noticia; ?>" width="100px"/></label>
                     <input type="file" name="img_noticia"><input type="hidden" name="lim_tamano" value="12000000"/>
                        </div>
                       <div class="botones">
                       <button type="submit" name="modificar" class='btn'>Modificar datos</button>   
                       <button type="button" onclick=" location.href='../Noticias/' " class="btn">Volver</button>
                  </div>
                </form>
      </div>
      </div>
