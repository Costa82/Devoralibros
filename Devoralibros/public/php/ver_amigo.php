    ...
    <div class='contenedorAmigo'>
       ...
       ?>
        <form action="#" method="POST" class="login-form">
            ...
            ?>
            <button type="submit" name="enviarMail" class="boton" title='Enviar mensaje'>Enviar mensaje</button>
            <button type="button" onclick=" location.href='<?php echo $destino;?>' " title='Volver' class="boton">Volver</button>
          </div>
        </form>
    </div>
    </body>
