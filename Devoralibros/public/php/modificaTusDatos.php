      ...
      <body>
        <div class="container">
          <div class="form-box">
            ...
            <form enctype="multipart/form-data" action="../php/modificaTusDatos_header.php" method="POST" class="login-form">
             <?php
             ...
             <div class="form-group">
               <label>Cambia tu foto</label>
                 <input type="file" name="foto"><input type="hidden" name="lim_tamano" value="10000000"/>
             </div>
             <div class="form-group">
               <label>Libro favorito</label>
                 <input type="text" name="libro_favorito" value="<?php echo $libro_favorito; ?>"/>
             </div>
             <div class="form-group">
               <label>Libro que menos te gustó</label>
                 <input type="text" name="libro_odiado" value="<?php echo $libro_odiado; ?>">
             </div>
             <div class="form-group">
               <label>Autor favorito</label>
                 <input type="text" name="autor_favorito" value="<?php echo $autor_favorito; ?>">
             </div>
             <div class="form-group">
