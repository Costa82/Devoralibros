		...
		<div class="form-box">
            ...
            ?>
             <div class="form-group">
					...
					<div class="form-group">
						<label>Cambia la imagen del concurso: <img
							src="../img_concursos/<?php echo $img_concurso; ?>" width="100px" /></label>
						<input type="file" name="img_concurso"><input type="hidden"
							name="lim_tamano" value="12000000" />
					</div>
					<div class="botones">
						<button type="submit" name="modificar" class='btn'>Modificar datos</button>
						<button type="button" onclick=" location.href='../Concursos/' "
