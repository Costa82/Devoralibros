...
echo "<ul id='lista_principal_index'>
        <li id='inicio'><a href='../index.php' title='Inicio'><img src='../img/merendalia_logotipo_RGB-01.png' alt='Merendalia'/></a></li>";
            ...
            if (strpos($_SERVER['REQUEST_URI'], "reservas") !== false) {
                // reservas.php found
                echo "<li id='reservas'><a href='reservas.php' title='Reservas' class='seleccionado'>Reservas</a></li>";
            } else {
                echo "<li id='reservas'><a href='reservas.php' title='Reservas'>Reservas</a></li>";
            }
      ...
      echo "<li id='menu_moviles'><i class='fa fa-bars' aria-hidden='true'></i></a>
                <ul id='lista_movil'>
                    ...
                    <li id='reservas2'><a href='reservas.php' title='Reservas'>Reservas</a></li>
