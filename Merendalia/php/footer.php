<div class="footerPrincipal">
	...
	<div class="logo_footer">
		...
		} else if (strpos($_SERVER['REQUEST_URI'], "galeria") !== false || strpos($_SERVER['REQUEST_URI'], "eventos") !== false || 
		strpos($_SERVER['REQUEST_URI'], "espacio") !== false || strpos($_SERVER['REQUEST_URI'], "catering") !== false || 
		strpos($_SERVER['REQUEST_URI'], "contacto") != false || strpos($_SERVER['REQUEST_URI'], "legal") !== false || 
		strpos($_SERVER['REQUEST_URI'], "blog") !== false || strpos($_SERVER['REQUEST_URI'], "envio") !== false || 
		strpos($_SERVER['REQUEST_URI'], "cookies") !== false || strpos($_SERVER['REQUEST_URI'], "menus") !== false || 
		strpos($_SERVER['REQUEST_URI'], "proteccion") !== false) {
		...
		?>
			<li class="espacio oculto_movil_footer">Merendalia, el ocio a tu
				manera. Organiza tu evento, o ven a uno preparado por nosotros.</li>
	...
	<div class="informacion">
		...
		<?php
		if (strpos($_SERVER['REQUEST_URI'], "galeria") !== false || strpos($_SERVER['REQUEST_URI'], "eventos") !== false ||
		 strpos($_SERVER['REQUEST_URI'], "espacio") !== false || strpos($_SERVER['REQUEST_URI'], "catering") !== false || 
		 strpos($_SERVER['REQUEST_URI'], "contacto") != false || strpos($_SERVER['REQUEST_URI'], "legal") !== false || 
		 strpos($_SERVER['REQUEST_URI'], "cookies") !== false || strpos($_SERVER['REQUEST_URI'], "blog") !== false ||
		 strpos($_SERVER['REQUEST_URI'], "proteccion") !== false) {
			...
			echo '<li id="galeria"><a href="../galeria/" title="Galería">Galería</a></li>
                	...
                	<li id="proteccionDatos"><a href="../politica-privacidad-y-proteccion-datos/" title="Protección de datos">Política de privacidad y Protección de datos</a></li>';
		} else {
	...
	<div class="redes">
		...
		<a href="https://m.facebook.com/merendalia" title="Facebook"
			...
			aria-hidden="true"></i>
		</a> <a href="https://www.instagram.com/merendalia/" title="Instagram"
...
strpos($_SERVER['REQUEST_URI'], "proteccion") !== false) {
	...
	<p><a class="enlace_legal" href="../politica-privacidad-y-proteccion-datos/" title="Protección de datos">Política de privacidad y Protección de datos</a></p>';
} else {
	echo '<p><a class="enlace_legal" href="aviso-legal/" title="Aviso Legal">Aviso Legal</a></p>
	<p><a class="enlace_legal" href="politica-privacidad-y-proteccion-datos/" title="Protección de datos">Política de privacidad y Protección de datos</a></p>';
}
