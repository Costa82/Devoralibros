	...
	<div class="contenedor_productos">
		...
		<div class="comida">
			...
			<ul class="lista_productos_comida">
				...
				<li>
					<div class="img_producto_comida">
						<img src='../img/tortilla de patata.jpg'
				...
				<li>
					<div class="img_producto_comida">
						<img src='../img/brochetas chocolate.jpg'
							title='BROCHETAS DE FRUTA Y CHOCOLATE' class="queso" />
					</div>
					<div class="texto_producto_comida">
						<p>BROCHETAS DE FRUTA Y CHOCOLATE (6 UNIDADES)</p>
					</div>
					<div class="precio_producto_comida">
						<p>
							<strong>9 €</strong>
		...
		<div class="merienda">
			...
			<ul class="lista_productos_merienda">

				<li>
					<div class="img_producto_comida">
						<img src='../img/sandwiches.jpg' title='MENÚ INFANTIL'
							class="queso" />
					</div>
					<div class="texto_producto_comida">
						<p>
							MENÚ MERIENDA CUMPLEAÑOS INFANTIL: </br>- Snacks variados </br>-
							Bocaditos variados </br> &nbsp;&nbsp;&nbsp;* Croissant vegetal </br>
							&nbsp;&nbsp;&nbsp;* Sandwich mixto </br> &nbsp;&nbsp;&nbsp;*
							Pollo con lechuga </br> &nbsp;&nbsp;&nbsp;* Atún con tomate </br>-
							Refrescos y agua </br>- Postre: Brocheta de frutas con chocolate.
						</p>
					</div>
					<div class="precio_producto_comida">
						<p>
